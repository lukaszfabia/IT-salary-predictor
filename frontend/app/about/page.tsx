          ...
          <figure>
            ...
            <figcaption className="font-medium text-center mt-6">
              <div className="text-sky-500 dark:text-sky-400">
                <a href="https://github.com/lukaszfabia/" target="_blank">
                  Lukasz Fabia
                </a>
              </div>
              ...
              <div>
                <p className="text-lg font-sans font-light p-4 text-gray-300">
                  I wanted to create model to predict salaries based on
                  variables in offers to get knowladge how much can i earn as a
                  Junior programmer. Whats more I could use it for my Data
                  Science project. I used data from{" "}
